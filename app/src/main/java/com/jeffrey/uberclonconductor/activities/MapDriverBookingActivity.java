...
import com.jeffrey.uberclonconductor.models.Info;
...
import com.jeffrey.uberclonconductor.providers.GoogleApiProvider;
import com.jeffrey.uberclonconductor.providers.InfoProvider;
import com.jeffrey.uberclonconductor.providers.NotificationProvider;
...
import com.jeffrey.uberclonconductor.utils.DecodePoints;
...
public class MapDriverBookingActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private boolean mIsFinishBooking = false;
    ...
    private void calculateRide(){
        ...
        final double total = 3000 + (0.25 * mDistanceInMeters);
    ...
    private void finishBooking() {
        mClientBookingProvider.updateIdHistoryBooking(mExtraClientId).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                //LIMPIO TODOS LOS DATOS ALMACENADOS EN SHARE PREFERENCES
        ...
        mClientBookingProvider.getClientBooking(mExtraClientId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    mEditor = mPref.edit();
                    //OBTENGO EL ULTIMO ESTADO ALMACENADO EN EL SHARED PREFERENCES
